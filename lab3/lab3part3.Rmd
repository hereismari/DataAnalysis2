...
# 2. Modelo 2:  Regressão Logística + CSL
...
Não encontrei nenhum método específico para CSL no R, então uma abordagem similar é utilizar outra métrica para avaliar e gerar o modelo, assim a métrica utilizada foi Kappa (mais detalhes em [6]) que é tida como uma melhor métrica que a acurácia para dados desbalanceados.
...
acc.3 <- confusionMatrix(pred.3 > 0.7, teste$evadiu)
acc.3
